...
const command_1 = __webpack_require__(1);
const file_command_1 = __webpack_require__(4);
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.sameCoordinates = exports.testCoordinates = exports.coordinates = void 0;
var coordinates = function (schema, host, port) {
    return {
        schema: schema,
        hostname: host,
        port: port,
        toString: function () {
            if (schema === "same") {
                ...
                var fport = port === 80 || port === "80" ? "" : ":" + port;
...
var testCoordinates = function (host, port) {
    return exports.coordinates("http", host, port);
};
exports.testCoordinates = testCoordinates;
var sameCoordinates = function () {
    return exports.coordinates("same", undefined, undefined);
};
exports.sameCoordinates = sameCoordinates;
//# sourceMappingURL=EndpointsCoordinates.js.map
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.isAuthenticationBean = exports.authenticationBean = void 0;
var authenticationBean = function (token) {
    var buckets = [];
    for (var _i = 1; _i < arguments.length; _i++) {
        buckets[_i - 1] = arguments[_i];
    }
    return ({
        token: token,
        bucket: buckets[0],
...
exports.authenticationBean = authenticationBean;
function isAuthenticationBean(obj) {
    return obj !== undefined && typeof obj.token === "string" && obj.buckets !== undefined && Array.isArray(obj.buckets);
}
exports.isAuthenticationBean = isAuthenticationBean;
//# sourceMappingURL=AuthenticationBean.js.map
...
var isAuthenticationResponse = function (obj) {
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.isUploadResponse = void 0;
var isUploadResponse = function (obj) {
    return obj.filename !== undefined;
};
exports.isUploadResponse = isUploadResponse;
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.responseError = exports.responseUnauthorized = exports.responseOk = exports.isApiResponse = exports.response = void 0;
var HttpStatusCode_1 = __webpack_require__(13);
var response = function (code, message) {
...
var responseOk = function () { return exports.response(HttpStatusCode_1.HttpStatusCode.OK); };
exports.responseOk = responseOk;
var responseUnauthorized = function () { return exports.response(HttpStatusCode_1.HttpStatusCode.UNAUTHORIZED); };
exports.responseUnauthorized = responseUnauthorized;
var responseError = function () { return exports.response(HttpStatusCode_1.HttpStatusCode.INTERNAL_SERVER_ERROR); };
...
var btoa_1 = __importDefault(__webpack_require__(15));
...
var listResponse = function (bucket, files) {
...
var HttpException = (function (_super) {
    ...
    function HttpException(statusText, statusCode) {
        var _this = this;
        var message = "API response code: " + statusCode;
...
var HttpException_1 = __webpack_require__(18);
...
var objectifyMeta = function (extras) {
    var e_1, _a;
    var obj = {};
    try {
        for (var _b = __values(extras.entries()), _c = _b.next(); !_c.done; _c = _b.next()) {
            var v = _c.value;
            obj[v[0]] = v[1];
        }
    }
...
exports.objectifyMeta = objectifyMeta;
var stringifyMeta = function (extras) {
    return JSON.stringify(exports.objectifyMeta(extras));
};
exports.stringifyMeta = stringifyMeta;
var materializeMeta = function (meta) {
...
var AuthenticationException_1 = __webpack_require__(19);
var HttpException_1 = __webpack_require__(18);
var communicator = function (storage) {
    return {
        storage: function () {
            return storage;
        },
        post: function (authToken, url, obj) {
            var addr = storage.toString();
            if (!url.startsWith("/"))
                url = "/" + url;
            return fetch(addr + "/rest/v1" + url, {
                ...
                if (res.status === 401)
                    return res.text().then(function (data) {
                        throw new AuthenticationException_1.AuthenticationException(data);
                    });
                else if (res.status !== 200)
                    return res.text().then(function (data) {
                        throw new HttpException_1.HttpException(data, res.status);
                    });
                return res.json();
            });
        },
        delete: function (authToken, url) {
            var addr = storage.toString();
            var input;
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.Statika = exports.pair = exports.metaInfo = void 0;
__webpack_require__(23);
var Communicator_1 = __webpack_require__(21);
var MetaApi_1 = __webpack_require__(24);
var StorageApi_1 = __webpack_require__(25);
var SystemApi_1 = __webpack_require__(27);
var metaInfo = function (values) {
    var m = new Map();
    values.forEach(function (p) { return m.set(p.k, p.v); });
    return m;
};
exports.metaInfo = metaInfo;
var pair = function (k, v) { return ({
    k: k,
    v: v,
}); };
exports.pair = pair;
var Statika = function (coords) {
    var comm = Communicator_1.communicator(coords);
    return {
...
//# sourceMappingURL=Statika.js.map
...
var Utilities_1 = __webpack_require__(20);
var metaApi = function (communicator) {
    return {
        updateMetaInfo: function (bean, fileName, metaInfo) {
...
var UploadResponse_1 = __webpack_require__(11);
var UploadRequest_1 = __webpack_require__(14);
var DatatypeException_1 = __webpack_require__(26);
var ApiResponse_1 = __webpack_require__(12);
var storageApi = function (communicator) {
    return {
        uploadFile: function (bean, fileName, f, metaInfo, options) {
            if (metaInfo === void 0) { metaInfo = undefined; }
            if (options === void 0) { options = {}; }
            var req = UploadRequest_1.bufferUploadRequest(bean.bucket, fileName, f, metaInfo);
            return communicator.post(bean, "/file", req).then(function (data) {
                if (UploadResponse_1.isUploadResponse(data))
                    return data;
                throw new DatatypeException_1.DatatypeException("UploadResponse", data);
            });
        },
        deleteFile: function (bean, fileName, options) {
            if (options === void 0) { options = {}; }
            var addr = communicator.storage().toString();
            if (!fileName.startsWith("/"))
                fileName = "/" + fileName;
            return communicator.delete(bean, "" + addr + fileName).then(function (data) {
                if (ApiResponse_1.isApiResponse(data))
                    return data;
                throw new DatatypeException_1.DatatypeException("ApiResponse", data);
            });
        },
        listFiles: function (bean) {
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.DatatypeException = void 0;
var DatatypeException = (function (_super) {
    __extends(DatatypeException, _super);
    function DatatypeException(expected, obj) {
        return _super.call(this, "Expected <" + expected + ">, but got <" + JSON.stringify(obj) + "> instead") || this;
    }
    return DatatypeException;
}(Error));
exports.DatatypeException = DatatypeException;
//# sourceMappingURL=DatatypeException.js.map
...
var AuthenticationBean_1 = __webpack_require__(9);
var ApiResponse_1 = __webpack_require__(12);
var DatatypeException_1 = __webpack_require__(26);
var systemApi = function (communicator) {
    return {
        ping: function (bean) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2, communicator.get(bean, "/ping").then(function (data) {
                            if (ApiResponse_1.isApiResponse(data))
                                return data;
                            throw new DatatypeException_1.DatatypeException("ApiResponse", data);
                        })];
        ...
        issueToken: function (upload_key) {
            var buckets = [];
            for (var _i = 1; _i < arguments.length; _i++) {
                buckets[_i - 1] = arguments[_i];
            }
...
const { URL, URLSearchParams } = __webpack_require__(29);
const urlStateMachine = __webpack_require__(34);
const percentEncoding = __webpack_require__(42);
...
const URLSearchParams = __webpack_require__(44);
...
const conversions = __webpack_require__(31);
...
const Impl = __webpack_require__(33);
...
const usm = __webpack_require__(34);
const urlencoded = __webpack_require__(43);
const URLSearchParams = __webpack_require__(44);
...
const infra = __webpack_require__(40);
const { utf8DecodeWithoutBOM } = __webpack_require__(41);
const { percentDecodeString, utf8PercentEncodeCodePoint, utf8PercentEncodeString, isC0ControlPercentEncode,
  isFragmentPercentEncode, isQueryPercentEncode, isSpecialQueryPercentEncode, isPathPercentEncode,
  isUserinfoPercentEncode } = __webpack_require__(42);
...
const punycode = __webpack_require__(36);
const regexes = __webpack_require__(37);
const mappingTable = __webpack_require__(38);
const { STATUS_MAPPING } = __webpack_require__(39);
...
const { isASCIIHex } = __webpack_require__(40);
const { utf8Encode } = __webpack_require__(41);
...
const { utf8Encode, utf8DecodeWithoutBOM } = __webpack_require__(41);
const { percentDecodeBytes, utf8PercentEncodeString, isURLEncodedPercentEncode } = __webpack_require__(42);
...
const Function = __webpack_require__(45);
const implSymbol = utils.implSymbol;
const ctorRegistrySymbol = utils.ctorRegistrySymbol;
...
// EXTERNAL MODULE: ./node_modules/statika/build/index.js
var build = __webpack_require__(7);

// EXTERNAL MODULE: ./node_modules/whatwg-url/index.js
var whatwg_url = __webpack_require__(28);

// CONCATENATED MODULE: ./src/utilities.ts

function parseStorage(address) {
  const parsed = Object(whatwg_url["parseURL"])(address);
  if (parsed.scheme !== "http" && parsed.scheme !== "https") throw new Error(`Unsupported protocol: ${parsed.scheme}`); // default ports should be processed separately

  let port = parsed.port;
  if (port === null) port = parsed.scheme === "http" ? 80 : 443; // path shouldn't be longer than 1 element at this point

  if (parsed.path.length > 1) throw new Error(`Bucket shouldn't be exactly 1 folder, but got multiple: ${JSON.stringify(parsed.path)}`);
  return {
...
async function uploadAllFilesInFolder(api, bean, directory) {
  // get list of files in the specified directory
  const files = external_fs_default.a.readdirSync(directory);
  if (files.length === 0) throw new Error(`Directory [${directory}] has no files in it!`); // and upload them one by one

  for (let file of files) {
    const absolute = external_path_default.a.join(directory, file);
    const content = external_fs_default.a.readFileSync(absolute);
...
async function run() {
  const token = core_default.a.getInput('token');
  const storage = core_default.a.getInput('storage');
  let bucket = core_default.a.getInput('bucket');
  const directory = core_default.a.getInput('directory');
  const coords = parseStorage(storage);
  const api = Object(build["Statika"])(Object(build["coordinates"])(coords.schema, coords.host, coords.port)); // if bucket variable is defined - use it. use coords.path otherwise
  ...
  await uploadAllFilesInFolder(api, Object(build["authenticationBean"])(token, bucket), directory);
} // invoke action
